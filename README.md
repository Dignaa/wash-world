This repository contains the source code for Wash World's backend (NestJS) and frontend (React Native) apps. The project follows a monorepo structure using npm workspaces.
